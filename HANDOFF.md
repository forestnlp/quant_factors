...
20. **XGB 转正归档（待用户点头，默认方向=转正）**：结论正文见 PROJECT.md——同池 206 支、同种子、同标签、WFO 终裁 XGB RankIC 0.1166/同窗 +15.9%/0.71 全面温和胜 LGB 0.1143/0.62（第五次确认平台在信息不在裁判）。转正=ml_combo 默认 `--model xgb`、后续组合基线一律 mlb_xgb。**注意**：band 用 (0.10,0.50] 不动（结论40 永久维持）。
